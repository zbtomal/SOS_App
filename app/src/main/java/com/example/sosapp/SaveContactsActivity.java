...
public class SaveContactsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize hospital name and number EditTexts
    ...
    // Save hospital data to SharedPreferences
    private void saveData() {
        ...
        // Save police, fire, and friend numbers
    ...
    // Load saved hospital data from SharedPreferences
